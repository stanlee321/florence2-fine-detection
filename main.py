...
class Application:
    def __init__(self, 
        ...
        self.client_minio = Minio("0.0.0.0:9000",  # Replace with your MinIO storage address
    ...
    def process_message(self, message):
        ...
        output_value: dict = self.redis_client.get_value(input_key)
        ...
        for timestamp, details in extracted_data.items():
            ...
            llm_results = next(self.process_details(
                bucket_name,
                details,
                timestamp,
                video_id))
            ...
            key = f"video:{video_id}_label:{label}_timestamp:{timestamp}_task:fine"
